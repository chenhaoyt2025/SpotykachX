...
#include "engine/audrey2/EchoDelay.h"
#include "engine/audrey2/KarplusString.h"
...
class Engine {
    ...
    private:
        ...
        using VerbPtr = std::unique_ptr<daisysp::Chorus>;
        VerbPtr verb_;

        using EchoDelayPtr = std::unique_ptr<AudreyEchoDelay<kMaxEchoDelaySamp>>;
