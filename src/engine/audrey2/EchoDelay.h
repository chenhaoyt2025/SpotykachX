...
#include <daisysp.h>
#include "engine/audrey2/BiquadFilters.h"
...
class AudreyEchoDelay {
    ...
    public:
        ...
        {
            delay_smooth_coef_ = audrey_onepole_coef(time_s, sample_rate_);
        }
    ...
    private:
        ...
        AudreyEchoDelay(const AudreyEchoDelay &other) = delete;
        AudreyEchoDelay(AudreyEchoDelay &&other) = delete;
        AudreyEchoDelay& operator=(const AudreyEchoDelay &other) = delete;
        AudreyEchoDelay& operator=(AudreyEchoDelay &&other) = delete;
